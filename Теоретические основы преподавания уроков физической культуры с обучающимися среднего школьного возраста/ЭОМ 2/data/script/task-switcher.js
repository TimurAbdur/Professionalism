...
nextBtn.addEventListener('click',()=> {
    if(nextBtn.innerHTML == "Ответить") {
        ...
        if(numtaskNow == 9) {
            ...
            if(document.querySelector('.answer-9').value == 'физические способности' || document.querySelector('.answer-9').value == 'Физические способности')  { 
                ball++ 
        ...
        if(numtaskNow == 10) {
            ...
            if(document.querySelector('.answer-10').value == 'Физическая культура' || document.querySelector('.answer-10').value == 'физическая культура')  { 
                ball++ 
...
function quationSwitcher() {
    if(numtaskNow == 1 || numtaskNow == 2 || numtaskNow == 3 || numtaskNow == 6 || numtaskNow == 5 || numtaskNow == 6 || numtaskNow == 7 || numtaskNow == 8) document.querySelector('.task-text').innerHTML = "Выберите один правильный ответ:"
    if(numtaskNow == 9 || numtaskNow == 10) document.querySelector('.task-text').innerHTML = "Заполните пропуск:"
}