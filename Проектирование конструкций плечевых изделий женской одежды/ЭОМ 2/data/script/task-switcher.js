...
function taskDescSwitch(numtaskNow) {
    if(numtaskNow == 1 || numtaskNow == 2 || numtaskNow == 3 || numtaskNow == 4) {
        document.querySelector('.task-text').innerHTML = "Вам необходимо выбрать правильную модельную конструкцию плечевого изделия в соответствии с техническим эскизом:"
    }
        ...
        document.querySelector('.task-text').innerHTML = "Выбрать модель одежды, где вытачка перенесена в драпировку:"
    }
