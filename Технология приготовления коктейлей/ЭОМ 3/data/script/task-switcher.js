...
nextBtn.addEventListener('click',()=> {
    if(nextBtn.innerHTML == "Ответить") {
        ...
        if(numtaskNow == 1) {
            ...
            document.querySelector('.true-answer-1-3').setAttribute('disabled', true);
            document.querySelector('.true-answer-1-4').setAttribute('disabled', true);
            if(!(document.querySelector('.not-true-answer-1-2').checked) && document.querySelector('.true-answer-1-1').checked &&
            document.querySelector('.true-answer-1-3').checked && (document.querySelector('.true-answer-1-4').checked)) { 
                ball++ 
    ...
    document.querySelector('.true-answer-2-3').checked && (document.querySelector('.true-answer-2-4').checked)) { 
                ball++ 
        ...
        if(numtaskNow == 3) {
            ...
            document.querySelector('.not-true-answer-3-4').setAttribute('disabled', true);
    ...
    document.querySelector('.true-answer-3-2').checked && (document.querySelector('.true-answer-3-3').checked)) { 
                ball++ 
        ...
        if(numtaskNow == 4) {
            solvTask[3] = 1
            document.querySelector('.not-true-answer-4-3').setAttribute('disabled', true);
            ...
            document.querySelector('.true-answer-4-2').checked && (document.querySelector('.true-answer-4-4').checked)) { 
                ball++ 
        ...
        if(numtaskNow == 6) {
            solvTask[5] = 1
            document.querySelector('.not-true-answer-6-3').setAttribute('disabled', true);
            ...
            document.querySelector('.true-answer-6-4').setAttribute('disabled', true);
            if(!(document.querySelector('.not-true-answer-6-3').checked) && document.querySelector('.true-answer-6-1').checked &&
    document.querySelector('.true-answer-6-2').checked && (document.querySelector('.true-answer-6-4').checked)) { 
                ball++ 
        ...
        if(numtaskNow == 8) {
            ...
            if(document.querySelector('.answer-8').value == "1345" || document.querySelector('.answer-8').value == "1 3 4 5") { 
                ball++ 
        ...
        if(numtaskNow == 10) {
            ...
            document.querySelector('.answer-10-3').value == 4 && document.querySelector('.answer-10-4').value == 3 && document.querySelector('.answer-10-5').value == 5) { 
                ball++ 
